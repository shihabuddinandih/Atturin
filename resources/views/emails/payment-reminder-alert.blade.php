...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #1f2937;">
    <div style="max-width: 640px; margin: 0 auto; padding: 24px;">
        <h2 style="margin-bottom: 12px;">Reminder pembayaran pendaftaran event</h2>
        <p>Super admin, ada peserta yang perlu diingatkan untuk menyelesaikan pembayaran:</p>

        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin: 16px 0;">
            <p style="margin: 4px 0;"><strong>Event:</strong> {{ $event->nama_event ?? '-' }}</p>
            ...
            <p style="margin: 4px 0;"><strong>Link pendaftaran:</strong> <a href="{{ $paymentLink }}">{{ $paymentLink }}</a></p>
        </div>
